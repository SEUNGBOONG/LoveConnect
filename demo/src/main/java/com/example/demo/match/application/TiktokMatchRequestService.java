...
@Service
@Slf4j
public class TiktokMatchRequestService extends MatchRequestServiceTemplate<TiktokMatchRequest> {
    ...
    @Override
    protected int getRequesterDesire(TiktokMatchRequest request) {
